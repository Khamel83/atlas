#!/usr/bin/env python3
"""
Simple FREE Atlas Transcript Processor
Uses only Tavily (free tier) + requests for 100% free processing
"""
...
class SimpleFreeProcessor:
    """100% free processor using only free tools"""
    ...
    def search_transcript_sources(self, podcast_name, episode_title):
        ...
        # Build search queries - comprehensive search
        queries = [
        ...
        for query in queries:
            ...
            payload = {
                ...
                "search_depth": "basic",
                "include_domains": [
                    "lexfridman.com", "stratechery.com", "happyscribe.com",
                    "podscripts.co", "tapesearch.com", "transcripts.fm",
                    "omny.fm", "simplecast.com", "buzzsprout.com",
                    "spreaker.com", "soundcloud.com"
                ]
            }
    ...
    def extract_transcript_content(self, url, title=""):
        """Extract transcript content using requests (FREE)"""
        ...
        try:
            ...
            if self.looks_like_transcript(clean_text):
                print(f"   ✅ SUCCESS: Extracted {len(clean_text)} characters - FREE!")
                return clean_text  # FULL CONTENT - NO LIMITS!
            else:
    ...
    def process_episode(self, episode):
        ...
        for i, source in enumerate(sources[:8]):  # Try first 8 sources
            ...
            if content:
                transcript_info = {
                    ...
                    'url': source['url'],
                    'title': source['title'],
                    'source': f"requests_{source.get('query', 'search')}"
                }
    ...
    def run_continuous(self, chunk_size=100, max_chunks=None):
        ...
        print(f"🔧 Tools: Tavily + Requests (FREE)")
        print(f"💰 COST: $0.00")
